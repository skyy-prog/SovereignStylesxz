              ...
              {groupedItems.map((item, index) => (
                <React.Fragment key={index}>
                  ...
                  <div className='flex justify-around flex-col p-5'>
                    ...
                    <p>Date: {new Date(items.date).toLocaleString()}</p>
                  ...
                  <div className='flex justify-around items-center flex-row'>
                   <div className=' flex flex-col  justify-around gap-5'>
                      <p>${items.amount}</p>
                    <p>{items.payment ?  <b className=' text-green-400 cursor-pointer'>Done</b> : <b className=' cursor-pointer text-red-600'> Pending</b>}</p>
                   </div>
